...
def _get_disrupted_subregion_sector_list(which_subregion: str) -> List:
    ...
    # Key economic sectors: Finance, Commerce, Manufacturing, Agriculture, Transport, Energy
    key_sectors = ['FIN', 'COM', 'MAQ', 'AGU', 'TRA', 'ELE', 'PES', 'REF', 'CON', 'MIP']
    
    if which_subregion == "province":
        # Strategic province-sector combinations focusing on economic centers and their key industries
        ...
        # Strategic canton-sector combinations focusing on major cities and their specializations
